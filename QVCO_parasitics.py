...
#S-parameters
Name='Bank'
File_1 = f'Files/QVCO_IND/QVCO_{Name}_1.s4p'
File_2 = f'Files/QVCO_IND/QVCO_{Name}_2.s4p'
File_3 = f'Files/QVCO_IND/QVCO_{Name}_3.s4p'
File_4 = f'Files/QVCO_IND/QVCO_{Name}_4.s4p'
